export default function Footer() {
  ...
  const footerLinks = [
    ...
    },
    {
      title: "Connect",
      links: [
        { name: "Email", href: "mailto:hello@hugo.dev" },
    ...
    <footer class="bg-gray-900/50 border-t border-gray-800 mt-20">
      <div class="max-w-6xl mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div class="col-span-1 md:col-span-2">
            ...
            <p class="text-gray-400 mb-6 max-w-md">
              Full-stack developer and photography enthusiast crafting digital experiences and capturing moments.
            </p>
            <div class="flex gap-4">
              {socialLinks.map(social => (
                <a
                  ...
                  class="p-2 bg-gray-800 hover:bg-gray-700 rounded-lg text-gray-400 hover:text-white transition-all"
        ...
        <div class="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p class="text-gray-400 text-sm">
            Built with{" "}
            <span class="text-purple-400">SolidJS</span> &{" "}
